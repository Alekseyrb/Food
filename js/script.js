window.addEventListener('DOMContentLoaded', () => {
    ...
    //     sliderBtn = document.querySelector('.offer__slider-counter'),
    ...
    // showSlide(counter);
    //
    // currentCount.innerHTML = `<span id="current">0${counter}</span>`;
    //
    ...
    const slides = document.querySelectorAll('.offer__slide'),
        ...
        width = window.getComputedStyle(slidesWrapper).width; //получить все элементы которые применены к slidesWrapper со странички, а потом ширину его
